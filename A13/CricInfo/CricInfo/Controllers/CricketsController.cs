...
namespace CricInfo.Controllers
{
    ...
    {
        private CricInfoDbContext db = new CricInfoDbContext();
        ...
        public ActionResult Create([Bind(Include = "Id,Name,NOWC")] Cricket cricket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Name,NOWC")] Cricket cricket)
        {
            if (ModelState.IsValid)
            {
