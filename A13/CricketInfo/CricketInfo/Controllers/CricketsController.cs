...
using CricketInfo;
using CricketInfo.Data;

namespace CricketInfo.Controllers
{
    public class CricketsController : Controller
    {
        private CricketInfoDbContext db = new CricketInfoDbContext();
        ...
        public ActionResult Create([Bind(Include = "Id,TeamName,NOWC")] Cricket cricket)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,TeamName,NOWC")] Cricket cricket)
        {
            if (ModelState.IsValid)
            {
